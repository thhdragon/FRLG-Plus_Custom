...
{
    {CLASS_AQUA_ADMIN, 10, ITEM_NET_BALL },
    {CLASS_AQUA_LEADER, 20, ITEM_MASTER_BALL },
    {CLASS_AROMA_LADY, 10, ITEM_REPEAT_BALL },
    {CLASS_AROMA_LADY_2, 7, ITEM_REPEAT_BALL },
    {CLASS_BATTLE_GIRL, 6, ITEM_GREAT_BALL },
    {CLASS_BEAUTY, 20, ITEM_LUXURY_BALL },
    {CLASS_BEAUTY_2, 18, ITEM_LUXURY_BALL },
    {CLASS_BIKER, 5, ITEM_PREMIER_BALL },
    {CLASS_BIRD_KEEPER, 8, ITEM_PREMIER_BALL },
    {CLASS_BIRD_KEEPER_2, 6, ITEM_SAFARI_BALL },
    {CLASS_BLACK_BELT, 8, ITEM_POKE_BALL },
    {CLASS_BLACK_BELT_2, 6, ITEM_POKE_BALL },
    {CLASS_BOSS, 25, ITEM_ULTRA_BALL },
    {CLASS_BUG_CATCHER, 4, ITEM_NET_BALL },
    {CLASS_BUG_CATCHER_2, 3, ITEM_NET_BALL },
    {CLASS_BUG_MANIAC, 15, ITEM_NET_BALL },
    {CLASS_BURGLAR, 22, ITEM_POKE_BALL },
    {CLASS_CAMPER, 4, ITEM_NEST_BALL },
    {CLASS_CAMPER_2, 5, ITEM_NEST_BALL },
    {CLASS_CHAMPION, 50, ITEM_PREMIER_BALL },
    {CLASS_CHAMPION_2, 25, ITEM_ULTRA_BALL },
    {CLASS_CHANNELER, 8, ITEM_POKE_BALL },
    {CLASS_COLLECTOR, 15, ITEM_REPEAT_BALL },
    {CLASS_COOLTRAINER, 12, ITEM_ULTRA_BALL },
    {CLASS_COOLTRAINER_2, 9, ITEM_ULTRA_BALL },
    {CLASS_COOL_COUPLE, 6, ITEM_LUXURY_BALL },
    {CLASS_CRUSH_GIRL, 6, ITEM_LUXURY_BALL },
    {CLASS_CRUSH_KIN, 6, ITEM_LUXURY_BALL },
    {CLASS_CUE_BALL, 6, ITEM_PREMIER_BALL },
    {CLASS_DRAGON_TAMER, 12, ITEM_POKE_BALL },
    {CLASS_ELITE_FOUR, 25, ITEM_ULTRA_BALL },
    {CLASS_ELITE_FOUR_2, 25, ITEM_ULTRA_BALL },
    {CLASS_ENGINEER, 12, ITEM_TIMER_BALL },
    {CLASS_EXPERT, 10, ITEM_ULTRA_BALL },
    {CLASS_FISHERMAN, 10, ITEM_NET_BALL },
    {CLASS_FISHERMAN_2, 9, ITEM_NET_BALL },
    {CLASS_GAMER, 18, ITEM_TIMER_BALL },
    {CLASS_GENTLEMAN, 20, ITEM_LUXURY_BALL },
    {CLASS_GENTLEMAN_2, 18, ITEM_LUXURY_BALL },
    {CLASS_GUITARIST, 8, ITEM_PREMIER_BALL },
    {CLASS_HEX_MANIAC, 6, ITEM_POKE_BALL },
    {CLASS_HIKER, 10, ITEM_NEST_BALL },
    {CLASS_HIKER_2, 9, ITEM_NEST_BALL },
    {CLASS_INTERVIEWER, 12, ITEM_REPEAT_BALL },
    {CLASS_JUGGLER, 10, ITEM_REPEAT_BALL },
    {CLASS_KINDLER, 8, ITEM_POKE_BALL },
    {CLASS_LADY, 50, ITEM_LUXURY_BALL },
    {CLASS_LADY_2, 50, ITEM_LUXURY_BALL },
    {CLASS_LASS, 4, ITEM_GREAT_BALL },
    {CLASS_LASS_2, 4, ITEM_POKE_BALL },
    {CLASS_LEADER, 25, ITEM_ULTRA_BALL },
    {CLASS_LEADER_2, 25, ITEM_ULTRA_BALL },
    {CLASS_MAGMA_ADMIN, 10, ITEM_NEST_BALL },
    {CLASS_MAGMA_LEADER, 20, ITEM_MASTER_BALL },
    {CLASS_NINJA_BOY, 3, ITEM_PREMIER_BALL },
    {CLASS_OLD_COUPLE, 10, ITEM_LUXURY_BALL },
    {CLASS_PAINTER, 4, ITEM_REPEAT_BALL },
    {CLASS_PARASOL_LADY, 10, ITEM_LUXURY_BALL },
    {CLASS_PICNICKER, 4, ITEM_REPEAT_BALL },
    {CLASS_PICNICKER_2, 5, ITEM_REPEAT_BALL },
    {CLASS_PKMN_BREEDER, 10, ITEM_TIMER_BALL },
    {CLASS_PKMN_BREEDER_2, 7, ITEM_TIMER_BALL },
    {CLASS_PKMN_PROF, 25, ITEM_REPEAT_BALL },
    {CLASS_PKMN_RANGER, 12, ITEM_SAFARI_BALL },
    {CLASS_PKMN_RANGER_2, 9, ITEM_SAFARI_BALL },
    {CLASS_PKMN_TRAINER_3, 15, ITEM_PREMIER_BALL },
    {CLASS_PLAYER, 1, ITEM_ULTRA_BALL },
    {CLASS_POKEFAN, 20, ITEM_POKE_BALL },
    {CLASS_POKEMANIAC, 15, ITEM_REPEAT_BALL },
    {CLASS_POKEMANIAC_2, 12, ITEM_REPEAT_BALL },
    {CLASS_PSYCHIC, 6, ITEM_POKE_BALL },
    {CLASS_PSYCHIC_2, 5, ITEM_POKE_BALL },
    {CLASS_RICH_BOY, 50, ITEM_LUXURY_BALL },
    {CLASS_RIVAL, 4, ITEM_POKE_BALL },
    {CLASS_RIVAL_2, 9, ITEM_POKE_BALL },
    {CLASS_ROCKER, 6, ITEM_GREAT_BALL },
    {CLASS_RUIN_MANIAC, 15, ITEM_POKE_BALL },
    {CLASS_RUIN_MANIAC_2, 12, ITEM_POKE_BALL },
    {CLASS_SAILOR, 8, ITEM_DIVE_BALL },
    {CLASS_SAILOR_2, 8, ITEM_NET_BALL },
    {CLASS_SCHOOL_KID, 5, ITEM_POKE_BALL },
    {CLASS_SCIENTIST, 12, ITEM_TIMER_BALL },
    {CLASS_SIS_AND_BRO, 3, ITEM_REPEAT_BALL },
    {CLASS_SIS_AND_BRO_2, 1, ITEM_REPEAT_BALL },
    {CLASS_SR_AND_JR, 4, ITEM_POKE_BALL },
    {CLASS_SUPER_NERD, 6, ITEM_GREAT_BALL },
    {CLASS_SWIMMER_FEMALE, 2, ITEM_DIVE_BALL },
    {CLASS_SWIMMER_FEMALE_2, 1, ITEM_DIVE_BALL },
    {CLASS_SWIMMER_MALE, 2, ITEM_DIVE_BALL },
    {CLASS_SWIMMER_MALE_2, 1, ITEM_DIVE_BALL },
    {CLASS_TAMER, 10, ITEM_SAFARI_BALL },
    {CLASS_TEAM_AQUA, 5, ITEM_NET_BALL },
    {CLASS_TEAM_MAGMA, 5, ITEM_NEST_BALL },
    {CLASS_TEAM_ROCKET, 8, ITEM_POKE_BALL },
    {CLASS_TRIATHLETE, 10, ITEM_PREMIER_BALL },
    {CLASS_TUBER, 1, ITEM_DIVE_BALL },
    {CLASS_TUBER_2, 1, ITEM_DIVE_BALL },
    {CLASS_TUBER_3, 1, ITEM_DIVE_BALL },
    {CLASS_TWINS, 3, ITEM_POKE_BALL },
    {CLASS_TWINS_2, 3, ITEM_REPEAT_BALL },
    {CLASS_YOUNGSTER, 4, ITEM_POKE_BALL },
    {CLASS_YOUNGSTER_2, 4, ITEM_POKE_BALL },
    {CLASS_YOUNG_COUPLE, 8, ITEM_LUXURY_BALL },
    {CLASS_YOUNG_COUPLE_2, 7, ITEM_LUXURY_BALL },
    { 0xFF, 5, 0 },
};
...
static u8 CreateNPCTrainerParty(struct Pokemon *party, u16 trainerNum)
{
     ...
     && !(gBattleTypeFlags & (BATTLE_TYPE_BATTLE_TOWER | BATTLE_TYPE_EREADER_TRAINER | BATTLE_TYPE_TRAINER_TOWER)))
    {
        ...
        for (i = 0; i < sTrainers[trainerNum].partySize; ++i)
        {
            ...
            {
                if (gTrainerMoneyAndBallTable[j].classId == sTrainers[trainerNum].trainerClass)
                    break;
            }
