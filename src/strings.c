...
const u8 gText_Nuzlocke_Off[] = _("DISABLED");
...
const u8 gText_NoPMCOff[] = _("PKMN CTR ENABLED");
const u8 gText_NoPMCOn[] = _("PKMN CTR DISABLED");
const u8 gText_NoIH[] = _("NO ITEM HEALS");
const u8 gText_NoIHOff[] = _("ITEM USE ENABLED");
const u8 gText_NoIHBag[] = _("FIELD DISABLED");
const u8 gText_NoIHBattle[] = _("BATTLE DISABLED");
const u8 gText_NoIHBoth[] = _("BOTH DISABLED");
